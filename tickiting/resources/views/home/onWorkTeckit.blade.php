        ...
        <section class="container mt-4" style="padding-right: 0px;">
            ...
            <div class="row g-3 mt-3 container">
               ...
               <div class=" col-lg-6 col-md-6" >
                   ...
                   <a href="{{url('teckitDetailsSolved',$teckit->id)}}">
                       ...
                       <div class="card tecket-card px-3" >
                           <div class="card-body">
                               ...
                               <div class="row mt-2">
                                   ...
                                   <button class="col-lg-6 col-sm-12 ms-auto mt-2" style="background-color: #F2E160;;border: none;border-radius: 10px;width: 122px; height: 40px;font-size: 14px;">{{$teckit->status}}</button>
                               </div>   
                           </div>
                       </div>
