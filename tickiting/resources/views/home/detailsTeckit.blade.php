...
<body>
    ...
    <div class="col-lg-12 col-xl-8 ">
        ...
        <div class="d-flex mt-3 container" >
            ...
            <h3 style="font-size: 22px;font-weight: bold;color: #000000;">On Work Tickets</h3>
        ...
        <section class="container">
            <div class="d-flex justify-content-end align-items-center gap-2" >
                @if(Auth::user()->usertype == 'tecknetion')
                @if($teckit->status == 'pinding')
                <form method="POST" action="{{ route('teckit.accept', $teckit->id) }}">
                    @csrf
                    <button type="submit" id="acceptTicketBtn" class="btn btn-ticket mt-5" style="width: 210px; height: 56px;border-radius: 11px;background: #8cdd95;color: white;font-size: 18px;font-weight: normal;">Accept Ticket</button>
                    <button type="button" class="btn btn-ticket mt-5" data-bs-toggle="modal" data-bs-target="#myModal" style="width: 210px; height: 56px;border-radius: 11px;background-color:#E68282;color: white;font-size: 18px;font-weight: normal;"  >Reject Ticket </button>
                ...
                @endif
                @else
                <button type="button" class="btn btn-ticket mt-5" data-bs-toggle="modal" data-bs-target="#myModal" style="width: 210px; height: 56px;border-radius: 11px;background-color:#E68282;color: white;font-size: 18px;font-weight: normal;"  >Cancel Ticket </button>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="headerModel" style="color: black;">Reject the ticket</h4>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <h5 style="color: #767676;" class="headerModel">Please provide the reason of rejection.</h5>
                                    <div class="input-group">
                                        <textarea class="form-control" aria-label="With textarea" style="height: 250px;background-color: #EFEFEF;" placeholder="Reason of rejection" id="rejectTextarea"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">

                                    <form method="POST" action="{{ route('teckit.reject', $teckit->id) }}">
                                        @csrf
                                        <button type="submit" class="btn btn1" style="background-color: #E68282;color: white;" onclick="submitRejected()">Reject Ticket</button>
                                    </form>
            ...
            <div class="card tecket-card2 " style="height: 100%;">
                <div class="card-body">
                    ...
                    <div class=" mt-3 ms-2 ">
                        ...
                        <button id="status" class="px-3 py-1 my-3" style="
            background-color:@if($teckit->status == 'processing') #F2E160;
                             @elseif($teckit->status == 'completed') #8CDD95;
                             @elseif($teckit->status == 'pinding')  #F2C060;
                             @elseif($teckit->status == 'canceled') #E68282 ;
                             @elseif($teckit->status == 'rejected') #B481E6 ;
                             @endif border: none;border-radius: 10px;width: 122px; height: 40px;">{{$teckit->status}}</button>


@if($teckit->status == 'processing')

<button data-bs-toggle="modal1" data-bs-target="#myModal1" class="ms-auto m-1" style="background-color: #60f27b;border: none;border-radius: 10px;width: 122px; height: 40px;">Solved</button>
@endif
        ...
        <div class="col-lg-6 col-md-6 mt-3">
            ...
            <!-- Modal -->
            <div class="modal fade text-white" id="myModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="headerModel" style="color: black;">Solved the Ticket?</h4>
                        ...
                        <div class="modal-body">
                            <h6 style="color: #767676;" class="headerModel">That's great! Please provide the methodology you took to solve this ticket.</h6>
                            <div class="input-group">
                                <textarea class="form-control" aria-label="With textarea1" style="height: 250px;background-color: #EFEFEF;" placeholder="Solution of ticket" id="solutionTextarea"></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <form method="POST" action="{{ route('teckit.complete', $teckit->id) }}">
                                @csrf
                                <button type="submit" class="btn btn1" style="background-color: #8CDD95;color: white;" data-bs-dismiss="modal1" onclick="submitSolution()">Submit Solution</button>

                                {{-- <button type="submit" class="btn btn-success">Accept</button> --}}
                            </form>
                            <button type="button" class="btn btn-dark btn1" data-bs-dismiss="modal1">Back</button>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="mt-3 container" style="padding-right: 0px;">
    <div class="card tecket-card3 " >
        <div class="card-body">
            <div class=" mx-4 my-3">
                ...
                <p style="font-size: 18px;line-height: 22px;color: #767676;">{{$teckit->description}}
                </p>
            </div>   
        </div>
    </div>
    ...
    @if($teckit->status == 'canceled'||$teckit->status == 'rejected')
    <div class="card tecket-card3 mt-5" >
        <div class="card-body">
            <div class=" mx-4 my-3">
                <p style="font-size: 20px;font-weight: normal;color: #000000;">rejected reason</p>
                <p style="font-size: 18px;line-height: 22px;color: #767676;">{{$teckit->rejectReason}}
                </p>
            </div>   
        </div>
    </div>
        ...
        <div class="card tecket-card3 " >
            <div class="card-body">
                <div class=" mx-4 my-3">
                    ...
                    <p style="font-size: 18px;line-height: 22px;color: #767676;">{{$teckit->solution}}
                    </p>
                </div>   
            </div>
        </div>
...
function submitRejected() {
    const rejectReason = document.getElementById('acceptTextarea').value;
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                // document.getElementById('status').style.backgroundColor='purple';
